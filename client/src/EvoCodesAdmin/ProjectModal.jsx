...
import { Plus, Search, Loader2, AlertCircle, ImagePlus, X, AlertTriangle } from 'lucide-react';
          ...
          <div className="w-full max-w-sm rounded-xl border border-slate-700 bg-slate-900 p-6 shadow-2xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-sm font-semibold text-white">{alertConfig.title}</h4>
                <p className="mt-1 text-xs text-slate-400">{alertConfig.message}</p>
              </div>
            </div>
